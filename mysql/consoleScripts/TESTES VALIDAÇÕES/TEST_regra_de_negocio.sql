...
-- Primeiro siga as instruções do readme.md disponivel na raiz do projeto
-- Então com todas tabelas, triggers e procedures criadas siga para o testes 


--  Teste 1 
-- 	  1.1 A empresa é organizada em Departamentos; OK
-- 	  1.2 Cada departamento possui um nome único;;  OK
    ...
    -- Resultado Teste 1
        ...
        1.2 O Nome esta com parametro UNIQUE para garantir que não seja gravado dados iguais 
...
--  Teste 5
-- 	  5.1 Um funcionário pode trabalhar em diversos projetos, tendo a carga horária que é gasta em cada;
...
--  Resultado teste 6
    ...
    -- o papel de dela é apenas ter  associação do funcionario e projeto não vai apagar o funcionario ou projeto em questão.
...
--  Teste10 
 ...
 -- Resultado teste 10
      -- 10 .1   Ao atualizar  a quantidade de horas realizadas automaticamente o prazo vai ser ataulizado pela trigger 003trg_atualiza_prazo_estimado